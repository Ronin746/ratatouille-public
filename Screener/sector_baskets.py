...
SECTOR_BASKETS = {
    ...
    "AUTONOMOUS DRIVING": ["LAZR", "INVZ", "OUST", "AEVA", "HSAI", "LIDR", "MVIS", "AUR", "MBLY", "TSLA", "UBER", "LYFT", "JOBY", "ACHR", "EH", "DRIV"],
    ...
    "KOREA": ["DDI", "MX", "EWY", "LPL", "SKM", "GRVY", "KB", "SHG", "KT", "WF", "CPNG", "GITS", "PXK"],
